...
/**
 * Exhibit Rating Tests
 * Tests for /v1/exhibits/:exhibit_id/ratings endpoints
 * 
 * Test Coverage:
 * - Rating submission (authenticated)
 * - Rating calculation (average updates)
 * - Input validation (range 1-5)
 * - Idempotency (updating existing ratings)
 */
