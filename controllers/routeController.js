...
/**
 * Helper to handle route ownership verification and error catching
 * Reduces cyclomatic complexity by centralizing validation logic
 * @param {Function} handler - Async controller function (req, res, route_id)
 */
