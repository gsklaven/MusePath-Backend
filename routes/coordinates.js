 ...
 * @access  Public
 */
router.get('/:user_id', coordinateController.getCurrentCoordinates);
 ...
 * @access  Public
 */
router.put('/:user_id', validateCoordinateUpdate, coordinateController.updateCurrentCoordinates);
